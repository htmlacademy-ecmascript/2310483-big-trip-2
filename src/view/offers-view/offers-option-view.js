...
const createOffersOptionTemplate = (offerOption) => `
  <div class="event__offer-selector">
      <input class="event__offer-checkbox  visually-hidden" id="${offerOption.id}" type="checkbox" name="${offerOption.value}" checked>
...
export default class OffersOptionView {
  constructor(offerOption) {
    this.offerOption = offerOption;
    this.element = null;
  }

  getTemplate() {
    return createOffersOptionTemplate(this.offerOption);
  }
